...
```json
{
  ...
  "content": "콘센트 자리 넉넉한 곳 위주로 골라봤어요.",
  "city": "성수"
}
```
...
```json
{
  ...
  "tastingNote": "초콜릿 뉘앙스가 은은하게 남아요.",
  "brewNote": "40ml bloom 30초 후 3번에 나눠 부었어요."
}
```
...
```json
{
  ...
  "tastingNote": "초콜릿 뉘앙스가 은은하게 남아요.",
  "brewNote": "40ml bloom 30초 후 3번에 나눠 부었어요.",
  "createdAt": "2026-05-20T08:20:00+09:00"
}
```
...
현재 앱/웹은 별도 서버 테이블 없이 온디바이스 계산으로 랭킹을 구성한다.
...
2. 평점 랭킹
3. 리뷰 수 랭킹
4. 현재 위치 기준 nearby 랭킹

현재 미지원:

1. `rank_snapshots` 기반 서버 스냅샷 랭킹
2. 기간별 랭킹
3. 배지 / 트렌드 지표
